...
package com.chrislaforetsoftware.fed.util;
 
import com.chrislaforetsoftware.util.Field;
 
/** Container for a FedWire's field tag and value.
 * 
 * @author Christopher Laforet
 */
 
public class FedWireField extends Field
    {
    public FedWireField(String Tag,String Value)
        {
        super(Tag,Value);
        }
